...
export default function Home() {
    return (
        <Layout className="">
            <SEO
                title="Situesyen Landing Page 🚀"
                description="Situesyen Landing Page!, Selamat datang di landing page kami, halaman ini bersifat testing dan open untuk pengembangan."
            />
                    ...
                    >
                        <SectionContainer id="features" className="features">
                            ...
                            <PageTitle
                                ...
                                type="default"
                            >
                                Situesyen Landing Page
                            </PageTitle>
                            <Content className="text-center" alignment="center">
                                <p>
                                    Halaman ini bersifat preview, open untuk
                                    customisasi.
                                </p>
                            </Content>
                            <ContentImage />
